    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CheffID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CheffNameSurname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CheffTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CheffDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CheffImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cheffs", x => x.CheffID);
                });
